...
public class ItemUtils_1_21_1 implements ItemUtils {
	...
	public <T> T getNBT(ItemStack item, String key, Class<T> typeClass) {
		if (item == null || item.getType() == Material.AIR || key == null || key.isEmpty() || typeClass == null) {
			return null;
		}
	...
	public void setName(ItemStack item, String name) {
		...
		meta.setDisplayName(this.translateColor(name));
		item.setItemMeta(meta);
	}
